...
public class ItemBackFragment extends Fragment {
    ...
    public static ItemBackFragment instence;
...
//    private int nPos;
    ...
    public static ItemBackFragment getInstence() {
        if (instence == null) {
            instence = new ItemBackFragment();
        }
        return instence;
    }
                ...
                switch (msg.what) {
                    case 100:
                        if (mlFileInfos != null && mlFileInfos.size() != 0) {
                            ...
                            if (getActivity() != null) {
                                playback_add_dev.setVisibility(View.VISIBLE);
                            }
                            dialog.dismiss();
                        }
