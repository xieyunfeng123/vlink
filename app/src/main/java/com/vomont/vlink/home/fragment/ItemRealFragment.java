...
public class ItemRealFragment extends Fragment implements View.OnTouchListener {
...
//    ImageView video_control_play;
//
//    @BindView(R.id.video_top_ll)
//    LinearLayout video_top_ll;
//
//    @BindView(R.id.surfaceview_layout_one)
//    RelativeLayout surfaceview_layout_one;
//
//    @BindView(R.id.real_progressbar_one)
//    ProgressBar real_progressbar_one;
//
//    @BindView(R.id.real_add_dev_one)
//    ImageView real_add_dev_one;
//
//    @BindView(R.id.surfaceview_layout_two)
//    RelativeLayout surfaceview_layout_two;
//
//    @BindView(R.id.real_progressbar_two)
//    ProgressBar real_progressbar_two;
//
//    @BindView(R.id.real_add_dev_two)
//    ImageView real_add_dev_two;
//
//    @BindView(R.id.video_bottom_ll)
//    LinearLayout video_bottom_ll;
//
//    @BindView(R.id.surfaceview_layout_three)
//    RelativeLayout surfaceview_layout_three;
//
//    @BindView(R.id.real_progressbar_three)
//    ProgressBar real_progressbar_three;
//
//    @BindView(R.id.real_add_dev_three)
//    ImageView real_add_dev_three;
//
//
//    @BindView(R.id.surfaceview_layout_four)
//    RelativeLayout surfaceview_layout_four;
//
//    @BindView(R.id.real_progressbar_four)
//    ProgressBar real_progressbar_four;
//
//    @BindView(R.id.real_add_dev_four)
//    ImageView real_add_dev_four;
//
//    @BindView(R.id.realplay_scroll_bg)
//    ScrollView realplay_scroll_bg;
//
//    @BindView(R.id.video_all)
//    LinearLayout video_all;
//
//    //标高清切换的view
//    @BindView(R.id.stream_type)
//    TextView stream_type;
    ...
    public static ItemRealFragment instance;
    //播放设备的信息
    ...
    public static ItemRealFragment getInstance() {
        if (instance == null) {
            instance = new ItemRealFragment();
        }
        return instance;
    }
            ...
            public void onPlayFailed() {
                if (getActivity() != null && real_progressbar != null) {
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            real_progressbar.setVisibility(View.GONE);
                            real_add_dev.setVisibility(View.VISIBLE);
...
//        mPopupWindow.setAnimationStyle(R.style.PopupAnimation);
    ...
    @OnClick({R.id.surfaceview_layout, R.id.video_control_play, R.id.stream_type, R.id.video_take_photo, R.id.control_video_camera, R.id.control_video_yunnan, R.id.control_video_video, R.id.real_add_dev, R.id.video_voice})
...
//                recordVideo();
    ...
    public void setOnAddDevClick(OnClickListener onClickListener) {
