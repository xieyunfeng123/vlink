...
public class OKHttpClientManager
{
        ...
        call.enqueue(new Callback()
        {
            ...
            public void onResponse(Response response)
            {
                ...
                try
                {
                    ...
                    File newfile = new File(destFileDir);
                    if(!newfile.exists())
                    {
                        newfile.mkdirs();
                    }
    ...
    public static Response post(String url, Param... params)
        throws IOException
    {
    ...
    public static Response post(String url, File[] files, String[] fileKeys, Param... params)
        throws IOException
    {
    ...
    public static Response post(String url, File file, String fileKey, Param... params)
        throws IOException
    {
