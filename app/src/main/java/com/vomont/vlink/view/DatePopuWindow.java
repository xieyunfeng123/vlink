...
public class DatePopuWindow extends PopupWindow
{
    ...
    public DatePopuWindow(Activity context)
    {
        ...
        if (null != date)
        {
            ...
            send_img_date.setCalendarDayBgColor(date, R.mipmap.new_dot_three);
        }
        
        // 监听所选中的日期
        send_img_date.setOnCalendarClickListener(new KCalendar.OnCalendarClickListener()
        {
            public void onCalendarClick(int row, int col, String dateFormat)
            {
                ...
                else
                {
                    ...
                    send_img_date.setCalendarDayBgColor(dateFormat, R.mipmap.new_dot_three);
        ...
        send_img_date.setOnCalendarDateChangedListener(new KCalendar.OnCalendarDateChangedListener()
        {
            @Override
    ...
    private void initView()
    {
        ...
        mMenuView.setOnTouchListener(new OnTouchListener()
        {
            ...
            public boolean onTouch(View v, MotionEvent event)
            {
                ...
                if (mMenuView.findViewById(R.id.date_win_bg) != null)
                {
                    int height = mMenuView.findViewById(R.id.date_win_bg).getTop();
