...
public class StreamPlayer implements BackPlayCallBack {
    private int iFlag = 0;
    ...
    private WMVlinkerSDK.OnHasRealDataCallBackListener mHasRealDataCallBackListener = null;
...
//			DebugLogger.i("StreamPlayer: !IsPlaying" + m_player);
    ...
    public void setHasDataCallBack(WMVlinkerSDK.OnHasRealDataCallBackListener listener) {
