...
public class Constants {
	...
	public static final int WMEventType_Invalide = -1;
	public static final int WMEventType_VIDEO_LOST = 0;     //视频(信号)丢失*/
	public static final int WMEventType_EXTERNAL = 1;       //外部(信号量)报警
	public static final int WMEventType_VIDEO_COVERED = 2;  //视频遮盖
	public static final int WMEventType_MOTION = 3;         //移动侦测
	public static final int WMEventType_DISARM = 4;          //布撤防报警
	public static final int WMEventType_FACE_DETECTION = 5;  //人脸侦测
	public static final int WMEventType_ENTER_AREA = 6;      //目标进入区域
	public static final int WMEventType_LEAVE_AREA = 7;      //目标离开区域
	public static final int WMEventType_INTRUSION = 8;       //周界入侵（区域入侵）
	public static final int WMEventType_LEFT = 9;            //物品遗留
	public static final int WMEventType_TAKE = 10;           //物品拿取
}
